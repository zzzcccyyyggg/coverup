...
experiments/
├── scripts/                    # 实验运行与分析脚本
│   ├── experiment_config.yaml  # 实验矩阵配置（9项目×6变体×3种子）
...
├── traces/                     # JSONL trace 输出（gitignored）
...
# 分析日志
python3 experiments/scripts/analyze_log.py
...
- **6 种消融变体**：full / no_memory / no_repair / no_planner / no_blocker / baseline
- **3 个随机种子**：42, 123, 456
